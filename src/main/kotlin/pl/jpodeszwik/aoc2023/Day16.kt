...
fun nextNode(node: NodeWithDirection): NodeWithDirection {
...
fun splitHorizontal(node: NodeWithDirection): List<NodeWithDirection> {
    return when (node.direction) {
...
fun splitVertical(node: NodeWithDirection): List<NodeWithDirection> {
    return when (node.direction) {
...
fun mirrorSlash(node: NodeWithDirection): NodeWithDirection {
    return when (node.direction) {
...
fun mirrorBackSlash(node: NodeWithDirection): NodeWithDirection {
    return when (node.direction) {
